          ...
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0">
            <li>
              <div className="w-full">
                ...
                <div className="relative p-6" style={{ padding: '1.1rem' }}>
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>
                        Exceptional service and professionalism! Found my dream home with ease, thanks to E State's dedicated team. Highly recommended!"
                        </p>
                      </blockquote>
                ...
                <div className="overflow-hidden">
                  <div className="relative p-6 style={{ padding: '1.1rem' }}">
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>
                        E State exceeded my expectations! From property selection to finalizing the deal, their expertise made the process seamless. Impressed
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                        <span
              ...
              <div className="w-full">
                ...
                <div className="relative p-6" style={{ padding: '1.1rem' }}>
                    <figure className="relative z-10">
                      <blockquote className="p-6 text-lg leading-loose lg:text-xl">
                        <p>
                        Efficient and knowledgeable staff at E State made my property search a breeze. Great communication and excellent options to choose from. Almost perfect!
                        </p>
                      </blockquote>
                      <figcaption className="flex flex-col items-center gap-2 p-6 text-sm text-emerald-500">
                        <span
